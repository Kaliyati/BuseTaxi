...
public class RaiderRegistration extends AppCompatActivity implements View.OnClickListener {
    Button buttonSignup;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_raider_registration);
    ...
    private void registerUser() {
        ...
        final ProgressDialog progressDialog= new ProgressDialog(RaiderRegistration.this);
       ...
       progressDialog.show();
        ...
        if (email.contentEquals("") || password.contentEquals("") || phoneNumber.contentEquals("")){
            Toast.makeText(RaiderRegistration.this,"Fill in all the Feilds", Toast.LENGTH_LONG).show();
           progressDialog.hide();
